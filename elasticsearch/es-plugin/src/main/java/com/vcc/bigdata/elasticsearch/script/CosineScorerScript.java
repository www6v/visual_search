...
public class CosineScorerScript extends AbstractDoubleSearchScript {
	private  final Logger logger = LoggerFactory.getLogger(CosineScorerScript.class);
...
//		double[] arrayInIndex1 = fList.stream().mapToDouble(Long::longValue).toArray();
//
//		return jniReco.featureSimilarity(fea, arrayInIndex1);
//	}
}
